...
use rest\models\master\GlobalConfig as GlobalConfigModel;

/**
 * GlobalConfig represents the model behind the search form about `rest\models\master\GlobalConfig`.
 */
