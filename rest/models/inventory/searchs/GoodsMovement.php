...
namespace rest\models\inventory\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use rest\models\inventory\GoodsMovement as GoodsMovementModel;

/**
 * GoodsMovement represents the model behind the search form about `rest\models\inventory\GoodsMovement`.
 */
