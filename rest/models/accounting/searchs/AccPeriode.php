...
use rest\models\accounting\AccPeriode as AccPeriodeModel;

/**
 * AccPeriode represents the model behind the search form about `rest\models\accounting\AccPeriode`.
 */
