...
namespace rest\models\purchase\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use rest\models\purchase\Purchase as PurchaseModel;

/**
 * Purchase represents the model behind the search form about `rest\models\purchase\Purchase`.
 */
