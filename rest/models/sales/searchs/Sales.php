...
namespace rest\models\sales\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use rest\models\sales\Sales as SalesModel;

/**
 * Sales represents the model behind the search form about `rest\models\sales\Sales`.
 */
