...
use app\api\models\inventory\GoodsMovement as GoodsMovementModel;

/**
 * GoodsMovement represents the model behind the search form about `app\api\models\inventory\GoodsMovement`.
 */
