...
use app\api\models\inventory\StockOpname as StockOpnameModel;

/**
 * StockOpname represents the model behind the search form about `app\api\models\inventory\StockOpname`.
 */
