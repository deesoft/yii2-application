...
use app\api\models\master\GlobalConfig as GlobalConfigModel;

/**
 * GlobalConfig represents the model behind the search form about `app\api\models\master\GlobalConfig`.
 */
