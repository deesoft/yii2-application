...
use app\api\models\master\PriceCategory as PriceCategoryModel;

/**
 * PriceCategory represents the model behind the search form about `app\api\models\master\PriceCategory`.
 */
