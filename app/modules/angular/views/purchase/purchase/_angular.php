    ...
    angular.module('dApp', [
        ...
        .config(['$routeProvider',
            function ($routeProvider) {
                $routeProvider.
                    when('/view/:id', {
                        templateUrl: '<?= Url::current(['template' => 'view']) ?>',
                        controller: 'ViewCtrl',
                        name: 'view',
                    }).
                    when('/edit/:id', {
                        templateUrl: '<?= Url::current(['template' => 'edit']) ?>',
                        controller: 'CreateEditCtrl',
                        name: 'edit',
                    }).
                    when('/create', {
                        templateUrl: '<?= Url::current(['template' => 'create']) ?>',
                        controller: 'CreateEditCtrl',
                        name: 'create',
                    }).
                    when('/receive/:id', {
                        templateUrl: '<?= Url::current(['template' => 'receive']) ?>',
                        controller: 'ReceiveCtrl',
                        name: 'receive',
                    }).
                    when('/list', {
                        templateUrl: '<?= Url::current(['template' => 'list']) ?>',
                        controller: 'ListCtrl',
                        name: 'list',
                    }).
                    otherwise({
