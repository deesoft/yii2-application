...
use app\models\master\PriceCategory as PriceCategoryModel;

/**
 * PriceCategory represents the model behind the search form about `app\models\master\PriceCategory`.
 */
